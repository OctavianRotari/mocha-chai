...
describe('Blobs', function() {
	...
	it('should update a SINGLE blob on /blob/<id> PUT', function(){
		chai.request(server)
		.get('/blobs')
		.end(function(err, res){
			chai.request(server)
	...
	it('should delete a SINGLE blob on /blob/<id> DELETE', function(){
		chai.request(server)
		.get('/blobs')
		.end(function(err, res){
			chai.request(server)
			...
			.end(function(err, res){
				...
				res.body.REMOVED.lastName.should.equal('man');
				done();
			});
		});
	});
